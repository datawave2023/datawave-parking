...
class DatospersonalesWidget extends StatefulWidget {
  const DatospersonalesWidget({
    Key? key,
    required this.iduder,
  }) : super(key: key);

  final DocumentReference? iduder;

  @override
  _DatospersonalesWidgetState createState() => _DatospersonalesWidgetState();
}
...
class _DatospersonalesWidgetState extends State<DatospersonalesWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget.iduder!),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Aqui podras actualizar tus datos personales',
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      controller: _model.emailAddressController2 ??=
                          TextEditingController(
                        text: containerUsersRecord.telefono.toString(),
                      ),
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.iduder!.update(createUsersRecordData(
                          displayName: _model.emailAddressController1.text,
                          telefono:
                              int.tryParse(_model.emailAddressController2.text),
                        ));
                      },
