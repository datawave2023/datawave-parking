...
import '/components/datospersonales_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final perfilusuarioUsersRecord = snapshot.data!;
                          ...
                          children: [
                            AuthUserStreamWidget(
                              builder: (context) => Text(
                                valueOrDefault(currentUserDocument?.telefono, 0)
                                    .toString(),
                            ...
                            await showModalBottomSheet(
                              ...
                              builder: (context) {
                                return WebViewAware(
                                  ...
                                  child: Padding(
                                    padding: MediaQuery.viewInsetsOf(context),
                                    child: DatospersonalesWidget(
                                      iduder: currentUserReference!,
                                    ),
                                  ),
                                ));
                              },
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            perfilusuarioUsersRecord.telefono
                                                .toString(),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
